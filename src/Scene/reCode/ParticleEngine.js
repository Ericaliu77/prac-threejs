	...
	this.particleMaterial = new THREE.ShaderMaterial(
		{
			...
			fragmentShader: particleFragmentShader,
			transparent: true, 
			alphaTest: 0.1, // if having transparency issues, try including: alphaTest: 0.5, 
			blending: THREE.NormalBlending, 
			depthTest: false
		});
...
ParticleEngine.prototype.initialize = function (scene) {
	...
	for (var i = 0; i < this.particleCount; i++) {
		...
		// console.log(this.particleArray[i], this.particleArray[i].position.toArray())
		this.particleArray[i].position.toArray(position, i * 3)
	...
	this.particleGeometry.setAttribute('position', new THREE.Float32BufferAttribute(position, 3))
	this.particleGeometry.setAttribute('customColor', new THREE.Float32BufferAttribute(customColor, 3))
	this.particleGeometry.setAttribute('customVisible', new THREE.Float32BufferAttribute(customVisible, 1))
	this.particleGeometry.setAttribute('customOpacity', new THREE.Float32BufferAttribute(customOpacity, 1))
	this.particleGeometry.setAttribute('customSize', new THREE.Float32BufferAttribute(customSize, 1))
	this.particleGeometry.setAttribute('customAngle', new THREE.Float32BufferAttribute(customAngle, 1))
...
ParticleEngine.prototype.update = function (dt) {
	...
	for (var i = 0; i < this.particleCount; i++) {
		...
		// this.particleGeometry.attributes.customColor[i * 3] = color[0]
		// this.particleGeometry.attributes.customColor[i * 3 + 1] = color[1]
		// this.particleGeometry.attributes.customColor[i * 3 + 2] = color[2]
	...
	for (var j = 0; j < recycleIndices.length; j++) {
		...
		this.particleArray[i].position.toArray(positionR, i * 3)
		// console.log(this.particleGeometry)
	//	 this.particleGeometry.vertices[i] = this.particleArray[i].position;
	    let pos = this.particleArray[i].position.toArray();
		this.particleGeometry.attributes.position[i*3] = pos[0]
		this.particleGeometry.attributes.position[i*3+1] = pos[1]
		this.particleGeometry.attributes.position[i*3+2] = pos[2]

	}
	//	this.particleGeometry.setAttribute('position', new THREE.Float32BufferAttribute(positionR, 3))
